...
several seconds for your data to come back. Yikes!
...
```
File_id_key                            Note_ownerId_updatedAt_idx
File_imageId_idx                       User_email_key
File_imageId_key                       User_id_key
Image_id_key                           User_username_key
Image_noteId_idx                       sqlite_autoindex_File_1
Image_userId_idx                       sqlite_autoindex_Note_1
Image_userId_key                       sqlite_autoindex_User_1
Note_id_key                            sqlite_autoindex__prisma_migrations_1
Note_ownerId_idx
```
...
If you're curious, our we just happen to have what's known as a "covering index"
