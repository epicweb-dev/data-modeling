			...
			create: {
				...
				file: {
					create: {
						...
						blob: new Uint8Array(
							await fs.promises.readFile('./tests/fixtures/images/notes/9.png'),
						),
					},
				},
			},
...
your exercise. You can <PrevDiffLink>check out my changes if you're interested</PrevDiffLink>.
No need to thank me. I'm just doing my job. 😎 (🦉 but you really
